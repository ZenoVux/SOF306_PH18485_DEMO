...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void loadAll() {
        ...
        StudentMap map = this.studentRepo.findAll();
        map.forEach((k, st) -> {
            Object[] row = new Object[] {
                st.getEmail(),
                st.getFullname(),
                st.getMarks(),
                st.getGender() ? "Male" : "Female",
                st.getCountry()
            };
    ...
    private void update() {
    	...
    	if (index != -1) {
    		String key = this.tblStudent.getValueAt(index, 0).toString();
        	Student student = this.getForm();
    		this.studentRepo.update(key, student);
    		this.loadAll();
    	}
    }
    ...
    private void delete() {
    	...
    	if (index != -1) {
    		String key = this.tblStudent.getValueAt(index, 0).toString();
    		this.studentRepo.delete(key);
    		this.tblStudent.remove(index);
    		this.loadAll();
    	}
    }
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(rdoMale, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(rdoFemale, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE))
